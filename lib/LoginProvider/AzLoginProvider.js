...
class AzLoginProvider {
    ...
    Login() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield main_1.executeAzCliCommand(`login`, false, execOptions, this.AzLoginCommandArgs);
                console.log(output);
            }
            catch (ex) {
                console.error(ex);
            ...
            if (this._info.SubscriptionId) {
                ...
                yield main_1.executeAzCliCommand(`account set`, false, execOptions, subscriptionArgs);
