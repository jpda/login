...
const ServicePrincipalLoginInfo_1 = require("./ServicePrincipalLoginInfo");
...
class AzLoginProvider {
    ...
    ConfigureAzPsSession() {
        if (this._info instanceof ServicePrincipalLoginInfo_1.ServicePrincipalLoginInfo) {
    ...
    Login() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield main_1.executeAzCliCommand(`login`, true, {}, this.AzLoginCommandArgs);
            ...
            if (this._info.SubscriptionId) {
                ...
                yield main_1.executeAzCliCommand(`account set`, true, {}, subscriptionArgs);
